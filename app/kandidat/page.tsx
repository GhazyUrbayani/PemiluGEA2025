      ...
      const dummyData: Candidate[] = [
        {
          ...
          mission: "1. Meningkatkan partisipasi aktif anggota dalam kegiatan himpunan<br>2. Memperkuat sinergi dengan alumni dan industri<br>3. Mengembangkan program pengembangan soft skill dan hard skill",
        ...
        },
        {
          ...
          mission: "1. Menyampaikan aspirasi mahasiswa ke KM ITB<br>2. Memperjuangkan kebijakan yang pro-mahasiswa<br>3. Transparansi penuh dalam setiap keputusan",
          hashtag: "#SuaraKita",
          position: "senator",
        },
      ];
